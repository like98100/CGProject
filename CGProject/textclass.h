...
public:
	...
	bool SetPlayerPosX(int, ID3D11DeviceContext*);
	bool SetPlayerPosY(int, ID3D11DeviceContext*);
	bool SetPlayerPosZ(int, ID3D11DeviceContext*);
private:
...
private:
	...
	SentenceType* m_time;
	SentenceType* m_score;
	SentenceType* m_hp;
	SentenceType* m_screenWidthText;
	SentenceType* m_screenHeightText;
	SentenceType* m_playerPositionX;
	SentenceType* m_playerPositionY;
	SentenceType* m_playerPositionZ;
};
